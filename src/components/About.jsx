      ...
      <div className="flex flex-col justify-center items-center w-full h-full">
        ...
        <div className="max-w-[1000px] w-full grid gap-8">
          <div className="text-center pb-8 px-4">
            <p className="border-b-4 border-gray-500 font-bold sm:text-6xl text-4xl">About</p>
          </div>

          <div></div>

          <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
            <div className="sm:text-right text-4xl text-[#a1a1a1] tracking-wide">
              <p className="tracking-wide text-justify">Hi I am Anshik Gupta, nice to meet you</p>
            </div>
            <div>
              <p className="tracking-wide text-2xl text-justify">
